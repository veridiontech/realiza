...
export function CreateUserRealiza() {
  ...
  return (
    <div className="dark:bg-primary flex flex-col gap-8 rounded-md bg-white p-6 shadow-md lg:p-10 m-20">
      <h1 className="text-xl font-bold lg:text-2xl">Crie um novo usuário para Realiza</h1>
      <form onSubmit={handleSubmit(createUser)} className="flex flex-col gap-6">
        <div className="flex justify-between gap-6 rounded-md border p-6 shadow-md dark:bg-primary items-center">
