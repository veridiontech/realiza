...
import { useBranch } from "@/context/Branch-provider"; // Caminho corrigido
                ...
                <div className="flex-1 rounded-xl shadow-md bg-white overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-[#6983BE] to-[#546A96] text-white px-8 py-6">
                        ...
                        <p className="text-sm underline opacity-90">
                            {/* Usa o nome da filial selecionada ou fallback */}
                            {selectedBranch?.name || client?.tradeName || "Nome Fantasia"}
                            &nbsp;/ 
                            {/* Usa o CNPJ da filial selecionada ou fallback */}
                            {selectedBranch?.cnpj || client?.cnpj || "CNPJ não disponível"}
                        </p>
                    </div>
