...
    try {
      const res = await axios.get<AuditLogResponse>(`${ip}/audit-log`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        params: {
...
                <th className="px-6 py-3 text-left font-semibold">Filial</th>
...
                      {item.branchName || "N/A"}
                    </td>
                    <td className="px-6 py-3 text-gray-700 max-w-xs whitespace-normal">
                      {
...
              className="bg-gray-300 text-gray-800 hover:bg-gray-400 disabled:opacity-50"
            >
              Anterior
            </Button>
            <Button
