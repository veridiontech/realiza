    ...
    <div className="flex flex-col items-start p-28">
      <div className="flex flex-col gap-8">
        ...
        >
          ...
          <span className="text-[14px] text-gray-600">Realiza sistema</span>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        >
          <div className="flex flex-col gap-1">
            ...
            <div className="px-2 text-[14px] list-disc">
              <li className="">
                Exibição das unidades nas quais o fornecedor está cadastrado.
              </li>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="px-2 text-[14px] list-disc">
              ...
              <li>Nome e sobrenome agora estão unificados em um único campo.</li>
              <li>Remoção dos campos "PJ" e "e-mail.</li>
              <li>Avaliação da possibilidade de incluir ficha de registro para colaboradores</li>
            </div>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <div className="px-2 text-[14px] list-disc">
              <li className="">
              Novo botão para alternar entre "Fornecedor" e "Subcontratado" durante o cadastro
              </li>
              <li>Envio automático de e-mail de convite para fornecedores e subcontratados..</li>
            </div>
          </div>
        </motion.ul>
      </div>
