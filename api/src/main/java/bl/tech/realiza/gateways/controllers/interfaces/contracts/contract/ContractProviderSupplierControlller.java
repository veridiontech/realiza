...
public interface ContractProviderSupplierControlller {
    ...
    ResponseEntity<Page<ContractResponseDto>> getAllContractsProviderSupplierBySupplier(int page, int size, String sort, Sort.Direction direction, String idSearch, List<Contract.IsActive> isActive);
    ResponseEntity<Page<ContractResponseDto>> getAllContractsProviderSupplierByClient(int page, int size, String sort, Sort.Direction direction, String idSearch, List<Contract.IsActive> isActive);
