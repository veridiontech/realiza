...
public class NotificationControllerImpl implements NotificationController {
    ...
    @Override
    public ResponseEntity<NotificationResponseDto> createNotification(NotificationRequestDto notificationRequestDto) {
        return null;
    }
    ...
    @ResponseStatus(HttpStatus.OK)
    @Override
    public ResponseEntity<Optional<NotificationResponseDto>> updateNotification(NotificationRequestDto notificationRequestDto) {
        return null;
    }
