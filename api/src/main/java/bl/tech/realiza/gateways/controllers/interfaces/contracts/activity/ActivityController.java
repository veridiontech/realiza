...
public interface ActivityController {
    ...
    ResponseEntity<ActivityDocumentResponseDto> addDocumentToActivity(String idActivity, String idDocumentBranch, Boolean replicate, List<String> branchIds);
    ResponseEntity<List<ActivityDocumentResponseDto>> addMultipleDocumentsToActivity(String idActivity, DocumentsToActivityRequest request);
    ResponseEntity<String> addActivitiesToBranches(AddActivitiesToBranchesRequest request);
