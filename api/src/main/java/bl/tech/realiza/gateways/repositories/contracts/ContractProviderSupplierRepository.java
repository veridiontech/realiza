...
public interface ContractProviderSupplierRepository extends JpaRepository<ContractProviderSupplier, String> {
    ...
    Page<ContractProviderSupplier> findAllByBranch_IdBranchAndProviderSupplier_IdProviderAndIsActiveIsTrue(String idBranch, String idSupplier, IsActive isActive, Pageable pageable);
