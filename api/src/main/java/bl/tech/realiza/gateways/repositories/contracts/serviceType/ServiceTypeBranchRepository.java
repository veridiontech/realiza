...
""")
    ...
    List<ServiceTypeBranch> findAllByBranch_Client_IdClientAndTitleAndRisk(String clientId, String title, RiskEnum risk);
    List<ServiceTypeBranch> findAllByBranch_IdBranchAndTitleAndRisk(String branchId, String title, RiskEnum risk);
}
