...
public interface DocumentBranchRepository extends JpaRepository<DocumentBranch, String> {
    ...
    List<DocumentBranch> findAllByBranch_IdBranchAndDocumentMatrix_SubGroup_Group_GroupNameAndLowRiskIsTrueAndIsActiveIsTrue(String idSearch, String groupName);
    List<DocumentBranch> findAllByBranch_IdBranchAndDocumentMatrix_SubGroup_Group_GroupNameAndMediumRiskIsTrueAndIsActiveIsTrue(String idSearch, String groupName);
    List<DocumentBranch> findAllByBranch_IdBranchAndDocumentMatrix_SubGroup_Group_GroupNameAndHighRiskIsTrueAndIsActiveIsTrue(String idSearch, String groupName);
