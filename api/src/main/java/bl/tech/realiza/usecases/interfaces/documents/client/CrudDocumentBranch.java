...
public interface CrudDocumentBranch {
    DocumentResponseDto save(DocumentBranchRequestDto documentBranchRequestDto);
    Optional<DocumentResponseDto> findOne(String id);
    Page<DocumentResponseDto> findAll(Pageable pageable);
    Optional<DocumentResponseDto> update(DocumentBranchRequestDto documentBranchRequestDto);
