...
//            query.distinct(true);
//
//            Join<ProviderSupplier, ContractProviderSupplier> supplierContractJoin = root.join("contractDocuments");
...
//    }
//
//    public static Specification<Provider> byStatuses(List<Document.Status> statuses) {
//        return (root, query, criteriaBuilder) -> {
...
//    }
//
//    public static Specification<Provider> byTitles(List<String> titles) {
//        return (root, query, criteriaBuilder) -> {
